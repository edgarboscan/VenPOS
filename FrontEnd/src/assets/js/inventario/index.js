...
class InventarioManager {
  ...
  /**
   * Muestra el Modal de productos
   * @param {*} id
   */

  async openModal(id) {
    // lógica para abrir el modal de edición o creación de producto
    console.log("Abrir modal para producto ID:", id);
    // Aquí puedes implementar la lógica para mostrar un modal con los detalles del producto
    await ensureSwal();
    const isNew = !id;
