...
<body class="h-100 w-100 app-page">
  ...
  <div class="app-layout">
    <section class="app-main">
      ...
      <section class="filtros-section" aria-label="Controles y filtros para el listado de productos">
        ...
        <div id="filtros-container" class="filtros-container">
            ...
            <nav style="--bs-breadcrumb-divider:
              ...
              <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item">
                  <a href="<?= BASE_URL ?>/FrontEnd/src/pages/home.php?title=Home">Home</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Productos</li>
              </ol>
            </nav>
          </div>
          <div class="header-control two d-flex flex-wrap gap-2 justify-content-end m-2">
            <button
              type="button"
          ...
          <div class=" header-control three filtros-form row gx-3 gy-2 align-items-center">
      ...
      <!-- Gráficos -->
      <section class="tables-container" aria-label="Gráficos de ventas y compras del mes">

        <div class="tables-container real-content">
          <div class="table-responsive">
            <table id="tabla_productos" class="table table-hover table-borderless align-middle">
              <thead>
                <tr>
