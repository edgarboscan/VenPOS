...
class MarcaController
{
  public static function search()
  {
    ...
    try {
      ...
      HelperController::checkAndLogProcedures($pdo, ['sp_marcas_listar_json']);
      $stmt = $pdo->prepare("CALL sp_marcas_listar_json(:search, :activo, :page, :per_page)");
      $stmt->execute([
        ':search' => $q,
        ':activo' => $activo,
        ':page' => $page,
      ...
      echo json_encode(['success' => false, 'error' => 'db_error', 'message' => 'Error al buscar marcas: ' . $e->getMessage()]);
    }
  }
}
